...
export default function DeliverySreen() {
    ...
    <View className="flex-1">
      ...
      >
        ...
        <View className="flex-1 ml-3">
          <Text className="text-lg font-bold text-white">George Sita</Text>
          <Text className="font-semibold text-white">Your Rider</Text>
        </View>
        <View className="flex-row items-center space-x-3 mr-3">
          <TouchableOpacity className=" bg-white rounded-full shadow p-2">
            <Icon.Phone
